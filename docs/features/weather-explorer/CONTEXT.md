...
- **comfort badge** — UI presentation of a comfort score: on day cards, a coloured circle with the numeric score and the rationale sentence centred below; on the weekend highlight card, score and rationale in a horizontal row. See [ui.md](./ui.md).
