...
| AC-04 — forecast happy path | loaded forecast shows seven day cards weekend highlight and hourly chart | unit, component, e2e-through-UI | Seven cards with weekday, °C high/low, icon, precipitation, wind, comfort badge with score and Ukrainian rationale; weekend headline equals mean Sat–Sun comfort; 48-hour hourly chart from local hour with sunrise/sunset note |
